<?php
	if ( ! current_user_can( 'manage_options' ) )
		wp_die( __( 'You do not have sufficient permissions to access this page.', 'appmaps' ) );
					...
					<tbody>
						<tr>
							...
							<td>
								...
								<br /><small><?php _e( 'If "YES" is selected, then plugin will add a map to edit listing page.', 'appmaps' ); ?></small>
							</td>
						</tr>
						<tr>
